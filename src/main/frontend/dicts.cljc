...
(def ^:large-vars/data-var dicts
  {:en {:accessibility/skip-to-main-content "Skip to main content"
   ...
   :uk {:accessibility/skip-to-main-content "Перейти до головної"
        ...
        {:ka {:accessibility/skip-to-main-content "მთავარ შიგთავსზე გადასვლა"
        :tutorial/text #?(:cljs (rc/inline "tutorial-ka.md")
                          :default "tutorial-ka.md")
        :tutorial/dummy-notes #?(:cljs (rc/inline "dummy-notes-ka.md")
                                 :default "dummy-notes-ka.md")
        :on-boarding/demo-graph "ეს სადემონსტრაციო გრაფია, ცვლილებები არ შეინახება სანამ საქაღალდეს არ გახსნით თქვენი კომპიუტერიდან."
        :on-boarding/add-graph "გრაფის დამატება"
        :on-boarding/open-local-dir "საქაღალდის გახსნა კომპიუტერიდან"
        :on-boarding/new-graph-desc-1 "Logseq-ს აქვს Markdown-ის და Org-mode-ს მხარდაჭერა. შეგიძლიათ არსებული საქაღალდის ან ახლის შექმნა თქვენს მოწყობილობაზე. თქვენი მონაცემები მხოლოდ ამ მოწყობილობაზე შეინახება."
        :on-boarding/new-graph-desc-2 "თქვენი საქაღალდის გახსნის შემდეგ, მასში სამი საქაღალდე შეიქმნება:"
        :on-boarding/new-graph-desc-3 "/journals - აქ შეინახება თქვენი ყოველდღიური ჩანაწერები (დღიური)"
        :on-boarding/new-graph-desc-4 "/pages - აქ შეინახება დანარჩენი გვერდები"
        :on-boarding/new-graph-desc-5 "/logseq - შეინახება კონფიგურაცია, custom.css, და პროგრამის ფუნქციონირებისთვის საჭირო სხვა ინფორმაცია."
        :on-boarding/welcome-whiteboard-modal-title "ტილო თქვენი ფიქრებისთვის."
        :on-boarding/welcome-whiteboard-modal-description "დაფა ხელსაწყოა დაფიქრებისთვის და ორგანიზებისთვის. აქ შეგიძლიათ დაალაგოთ თქვენი ფიქრები, ჩაიწეროთ ფაქტები, დაალაგოთ და ერთმანეთთან დაკავშიროთ ინფორმაცია, მოძებნოთ ასოციაციები და გაიაზროთ ახლებურად."
        :on-boarding/welcome-whiteboard-modal-skip "გამოტოვება"
        :on-boarding/welcome-whiteboard-modal-start "მოფიქრების დაწყება"
        :on-boarding/tour-whiteboard-home "{1} საწყისი თქვენი დაფებისთვის"
        :on-boarding/tour-whiteboard-home-description "Whiteboards have their own section in the app where you can see them at a glance, create new ones or delete them easily."
        :on-boarding/tour-whiteboard-new "{1} Create new whiteboard"
        :on-boarding/tour-whiteboard-new-description "There are multiple ways of creating a new whiteboard. One of them is always right here in the dashboard."
        :help/start "დაგეხმარებით დაწყებისთვის"
        :help/about "Logseq-ის შესახებ"
        :help/roadmap "საგზაო რუკა"
        :help/bug "შეცდომის შეტყობინება"
        :help/feature "ფუნქციის მოთხოვნა"
        :help/changelog "ცვლილებების ჟურნალი"
        :help/blog "Logseq-ის ჟურნალი"
        :help/docs "Documentation"
        :help/privacy "Privacy policy"
        :help/terms "Terms"
        :help/forum-community "Forum community"
